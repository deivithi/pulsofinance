...
export function AppHeader({ onMenuClick }: AppHeaderProps) {
  ...
  return (
    <header className="h-16 bg-background/70 backdrop-blur-2xl border-b border-border/40 sticky top-0 z-30 flex items-center justify-between px-4 md:px-8 transition-all">
